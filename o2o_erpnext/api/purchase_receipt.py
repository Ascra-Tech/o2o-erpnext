...
def get_permission_query_conditions(user):
    """
    Returns query conditions for Purchase Receipt list view based on user role
    """
    if not user:
    ...
    # First check if user is Administrator - show all PRs
    ...
    # If user has none of the allowed roles
        ...
        frappe.throw(_("Not Allowed to see PR"))
        return "1=0"
